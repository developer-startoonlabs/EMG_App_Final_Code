...
import com.startemg.apps.pheezee.fragments.SmileyMonitoringFragment; /** This File is for the SmileyMonitorFragment Theme, Calculation and Function will be return in that File **/
import com.startemg.apps.pheezee.fragments.StandardGoldTeachFragment; /** This File is for the ArcView Dialer show in Theme, Calculation and Function will be return in that File **/
import com.startemg.apps.pheezee.fragments.StarMonitorFragment;/**This File is for the StarMonitor show in Theme, Calculation and Function will be return in that File**/
import com.startemg.apps.pheezee.repository.MqttSyncRepository;/** Async and sending the data with help of using this activity **/
import com.startemg.apps.pheezee.room.Entity.SceduledSession;/** It is used for local database storage **/
import com.startemg.apps.pheezee.services.PheezeeBleService; /** Ble Service Pheezee Connection send the data and receiving the data  **/
import com.startemg.apps.pheezee.utils.TakeScreenShot;/** Screen Short Functionality **/
...
import static com.startemg.apps.pheezee.activities.SessionReportActivity.patientId;
import static com.startemg.apps.pheezee.utils.PackageTypes.ACHEDAMIC_TEACH_PLUS;
import static com.startemg.apps.pheezee.utils.PackageTypes.GOLD_PLUS_PACKAGE;
import static com.startemg.apps.pheezee.utils.PackageTypes.STANDARD_PACKAGE;
...
public class MonitorActivity extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener {
    ...
    static LinearLayout printer_linear_layout_bt;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        printer_linear_layout_bt = findViewById(R.id.printer_linear_layout);
 ...
 **/
    ...
    public void buttonStatus(String json_phizioemail, String patientname, JSONArray emg_value,String patientid) {
        printer_linear_layout_bt.setVisibility(View.VISIBLE);

        String phizio_email = json_phizioemail;
        String patient_name = patientname;
        String emg_array_data = emg_value.toString();
        String Patientid = patientid;

        print_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MonitorActivity.this, UitoPdfConvter.class);
                intent.putExtra("phizio_email", phizio_email);
                intent.putExtra("patient_name", patient_name);
                intent.putExtra("emg_array_data", emg_array_data);
